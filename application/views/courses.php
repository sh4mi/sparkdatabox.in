<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Courses Management
        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>admin/courses/add"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="box-body table-responsive no-padding">
                  <table id="categories_table" class="table table-hover table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td><img height="32px;" src="<?php echo base_url('assets/frontend/images/').$course['thumbnail']; ?>"/></td>
