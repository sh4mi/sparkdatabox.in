<?php
 $section = $this->crud_model->get_widget('feature','',$id)->row_array();
?>
<form action="<?php echo base_url('admin/widget_form/feature/').$id.'/'.$course_id;?>" method="post" enctype="multipart/form-data">
